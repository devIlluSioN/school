...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 104, 105, 113, 4745537, 4846113, 4849249, 5393365, 5442204, 5495052, 5594513, 5695307, 57476627, 76061764, 84982061, 87367608, 93036843, 142895325, 156956385, 302979532, 328878574, 359333139, 407283053, 452737314, 501039929, 503643935, 520590566, 589500950, 722696703, 727446804, 752681381, 784134345, 944645571, 946786476, 1036140334, 1042306895, 1067353468, 1092664259, 1103412149, 1114501250, 1170195731, 1181037546, 1204816148, 1217091629, 1224901875, 1228056441, 1247875546, 1280845662, 1282943179, 1324823451, 1330771252, 1352786672, 1398464674, 1431819701, 1436822557, 1512997393, 1532710347, 1547539107, 1604552446, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1768617329, 1818678820, 1830310359, 1902405251, 1915412854, 1916009602, 1932118984, 1981972957, 2025055113, 2049945213, 2054707467, 2082663554, 2105872637, 2127021138};
		
		protected static string[] fields = new string[]{"b", "h", "i", "q", "__a", "add", "arr", "len", "map", "nom", "pop", "run", "getEnumConstructs", "remove", "classe", "filter", "currentTest", "result", "method", "methodName", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "testClasse", "length", "getNom", "getPrenom", "customTrace", "assertEquals", "prenom", "success", "toString", "testNew", "m_tests", "splice", "cases", "copy", "done", "item", "join", "concat", "print", "next", "enumConstructor", "push", "sort", "quicksort", "runCase", "assertTrue", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "posInfos", "concatNative", "className", "backtrace", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "allEnums", "tearDown", "customParams", "classname", "__get", "__set", "error", "lineNumber", "unshift", "setup", "enumParameters", "shift", "assertFalse", "slice"};
